...
const KnowledgeArticleEditor = dynamic(
  () =>
    import("@/components/knowledge-base/knowledge-article-editor").then(
      (mod) => mod.KnowledgeArticleEditor
    ),
  {
...
const KnowledgeArticleInsights = dynamic(
  () =>
    import("@/components/knowledge-base/knowledge-article-insights").then(
      (mod) => mod.KnowledgeArticleInsights
    ),
  {
    loading: () => <div className="h-40 animate-pulse bg-muted rounded-xl" />,
    ssr: false,
