...
export const csmRoutes: CsmRoute[] = [
  {
    ...
    templateMetrics: [
      ...
      { label: "Active Customers", value: "286" },
      { label: "CSAT Score", value: "4.6/5", tone: "positive" },
    ],
    sidebarPreview: [
      {
        ...
        subject: "At a glance",
        date: "Today",
        teaser: "Key metrics, SLA status, and recent activity across your accounts.",
      },
      {
        title: "Recent tickets",
        subject: "Latest updates",
        date: "Now",
        teaser: "New, updated, and escalated tickets from the last 24 hours.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    templateMetrics: [
      ...
      { label: "Webhooks Active", value: "6" },
      { label: "SDK Versions", value: "4" },
    ],
    sidebarPreview: [
      {
        ...
        date: "Updated",
        teaser: "Integrate Gray CSM into your workflow in minutes.",
      },
      {
        title: "API reference",
        subject: "REST endpoints",
        date: "v2.1",
        teaser: "Full API documentation with request/response examples.",
      },
    ],
  },
]
